...
})({"EV41i":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = 1234;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d751713988987e9331980363e24189ce";
module.bundle.HMR_BUNDLE_ID = "400e4dee55dc62b95ac8bdd22d2c210d";
// @flow
...
},{}],"59gVk":[function(require,module,exports) {
var _componentsEditableQuizSection = require("./components/editable-quiz-section");
var _componentsModal = require("./components/modal");
var _componentsTextField = require("./components/text-field");
...
function Init(quiz) {
  ...
  $quiz.innerHTML = "";
  const $quizName = _componentsUtils.createElementFrom(`
    <div class="paper-6">
  ...
  const $btnWrap = _componentsUtils.createElementFrom(`
  ...
  $quiz.append(_componentsUtils.createElementFrom(`<div class="spacey-2"></div>`), $quizName, _componentsUtils.createElementFrom(`<div class="spacey-2"></div>`), $questsContainer, _componentsUtils.createElementFrom(`<span class="spacex-3"></span>`), $btnWrap, _componentsUtils.createElementFrom(`<div class="spacey-4"></div>`));
  const quizNameInput = new _componentsTextField.ULTextField($quizName.querySelector("#quiz-name"), {
    value: quiz.name,
  ...
  $addQuestBtn.addEventListener("click", () => {
    _componentsModal.selectModal("Choose the type of the quest", {
      label: "Type",
      required: true,
      options: [["question", "Question"], ["choose one", "Choose one"], ["choose multiple", "Choose multiple"], ["complete", "Complete text"], ["match", "Match sides"]].map(o => ({
        key: o[0],
        value: o[1]
      }))
    }).then(({key: type}) => {
      ...
      const eqs = new _componentsEditableQuizSection.EditableQuizSection($placeholder, {
        quest: newQuest
      });
...
},{"./components/editable-quiz-section":"3GV6Q","./components/modal":"6gzEr","./components/text-field":"3ZTJh","./components/utils":"1MFtj"}],"3GV6Q":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
_parcelHelpers.export(exports, "EditableQuizSection", function () {
  return EditableQuizSection;
});
...
class EditableQuizSection {
  ...
  */
  constructor($target, {quest}) {
    ...
    const titleInput = new _textField.ULTextField(this.$element.querySelector("#title-input"), {
      value: quest.title,
      multiline: true,
    ...
    const questionInput = new _textField.ULTextField(this.$element.querySelector("#question-input"), {
    ...
    this._validityHandlers = [() => titleInput.reportValidity() && questionInput.reportValidity()];
    ...
    const typeHandlers = {
      ...
      choose: multiple => {
        ...
        const $placeholder = document.createElement("div");
        const $addBtn = _utils.createElementFrom(`<button type="button" class="filled-button secondary small">add option</button>`);
        this.$content.append($form, _utils.createElementFrom(`<span class="spacex-2"></span>`), $addBtn);
      ...
      complete: () => {
        ...
        */
        const $editBtn = _utils.createElementFrom(`<button type="button" class="filled-button secondary small">edit</button>`);
        this.$content.append($completePlaceholder, $inputPlaceholder, _utils.createElementFrom(`<div class="spacey-1"></div>`), $editBtn);
        const complete = new _complete.Complete($completePlaceholder, {
          values: quest.answers,
          text: quest.text,
          disabled: true
        });
        const input = new _textField.ULTextField($inputPlaceholder, {
          placeholder: "Text [to complete]",
          multiline: true,
          required: true
        });
        if (quest.text && quest.answers) {
          input.value = _complete.unParseText({
        ...
        input.onBlur = () => {
          const p = _complete.parseText(input.value);
          complete.setText({
            text: p.parsedText,
            values: {
              ...p.values
      ...
      match: () => {
        ...
        const $addLeft = _utils.createElementFrom(`<button type="button" class="filled-button small secondary">add left</button>`);
        const $addRight = _utils.createElementFrom(`<button type="button" class="filled-button small secondary">add right</button>`);
        $btnWrap.append($addLeft, _utils.createElementFrom(`<span class="spacex-1"></span>`), $addRight);
        this.$content.append(_utils.createElementFrom(`<div class="spacey-1"></div>`), $btnWrap);
...
},{"./check-list":"5OpCq","./complete":"4g3Hn","./match":"6TdH9","./text-field":"3ZTJh","./utils":"1MFtj","@parcel/transformer-js/lib/esmodule-helpers.js":"417ty"}],"5OpCq":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
...
},{"./text-field":"3ZTJh","./utils":"1MFtj","@parcel/transformer-js/lib/esmodule-helpers.js":"417ty"}],"6gzEr":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
_parcelHelpers.export(exports, "promptModal", function () {
  return promptModal;
});
_parcelHelpers.export(exports, "selectModal", function () {
  return selectModal;
});
var _select = require("./select");
var _textField = require("./text-field");
var _utils = require("./utils");
function promptModal(what, {multiline = false, placeholder = "", value = "", required = false}) {
  let $modal = createModal(what);
  const input = new _textField.ULTextField($modal.querySelector("#content"), {
    multiline,
    placeholder,
    value,
    required
...
function selectModal(what, {label = "", required = false, options}) {
  let $modal = createModal(what);
  const select = new _select.Select($modal.querySelector("#content"), {
    label,
    required,
    options
  });
...
function createModal(title) {
  return _utils.createElementFrom(`
    <div class="modal">
...
},{"./select":"5yybA","./text-field":"3ZTJh","./utils":"1MFtj","@parcel/transformer-js/lib/esmodule-helpers.js":"417ty"}],"5yybA":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
_parcelHelpers.export(exports, "Select", function () {
  return Select;
});
var _utils = require("./utils");
class Select {
  ...
  * }} param1
  */
  constructor($target, {label = "", options = [], required = false}) {
    this.$element = _utils.createElementFrom(`
      <div class="ol-text-field select">
        <input class="ol-text-field__input" type="text" ${required ? "required" : ""} />
        ${label ? `<span class="ol-text-field__label">${label}</span>` : ""}
  ...
  */
  addOption(o) {
    const $option = _utils.createElementFrom(`
...
},{"./utils":"1MFtj","@parcel/transformer-js/lib/esmodule-helpers.js":"417ty"}]},["EV41i","59gVk"], "59gVk", "parcelRequiref125")

//# sourceMappingURL=create-quiz.2d2c210d.js.map
