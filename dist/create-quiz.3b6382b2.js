...
exports.Match = Match;
},{"./text-field":"components/text-field.js","./utils":"components/utils.js"}],"components/editable-quiz-section.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.EditableQuizSection = void 0;
...
var EditableQuizSection =
/**
 *
 * @param {HTMLElement} $target
 */
function EditableQuizSection($target, _ref) {
  var _this = this;

  var quest = _ref.quest;

  _classCallCheck(this, EditableQuizSection);
  ...
  $target.replaceWith(this.$element);
  var titleInput = new _textField.ULTextField(this.$element.querySelector("#title-input"), {
    value: quest.title,
    multiline: true,
  ...
  var questionInput = new _textField.ULTextField(this.$element.querySelector("#question-input"), {
  ...
  var $removeBtn = this.$element.querySelector(".quiz-section__remove");
  ...
  this._validityHandlers = [function () {
    return titleInput.reportValidity() && questionInput.reportValidity();
  }];

  this.reportValidity = function () {
    return _this._validityHandlers.every(function (fn) {
      return fn();
    });
  };
  ...
  var typeHandlers = {
    question: function question() {
      ...
      _this._validityHandlers.push(function () {
    ...
    choose: function choose(multiple) {
      ...
      var $placeholder = document.createElement("div");
      var $addBtn = (0, _utils.createElementFrom)("<button type=\"button\" class=\"filled-button secondary small\">add option</button>");

      _this.$content.append($form, (0, _utils.createElementFrom)("<span class=\"spacex-2\"></span>"), $addBtn);
      ...
      checklist.onChange = checklist.onRemove = function () {
        quest.answers = [];
        quest.options = checklist.items.map(function (i, idx) {
      ...
      _this._validityHandlers.push(function () {
        return checklist.reportValidity();
      });
      ...
      if (!quest.answers.length) checklist.addItem({
        value: ""
      });
    },
    ...
    complete: function complete() {
      ...
      var $completePlaceholder = document.createElement("div");
      var $inputPlaceholder = document.createElement("div");
      /**
       * @type {HTMLButtonElement}
       */

      var $editBtn = (0, _utils.createElementFrom)("<button type=\"button\" class=\"filled-button secondary small\">edit</button>");

      _this.$content.append($completePlaceholder, $inputPlaceholder, (0, _utils.createElementFrom)("<div class=\"spacey-1\"></div>"), $editBtn);

      var complete = new _complete.Complete($completePlaceholder, {
        values: quest.answers,
        text: quest.text,
        disabled: true
      });
      var input = new _textField.ULTextField($inputPlaceholder, {
      ...
      if (quest.text && quest.answers) {
        input.value = (0, _complete.unParseText)({
      ...
      var edit = function edit() {
        ...
        input.value = (0, _complete.unParseText)({
          ...
          values: _objectSpread({}, complete.values)
        });
      };

      complete.$element.addEventListener("click", function () {
        return edit();
      });
      ...
      input.onBlur = function () {
        var p = (0, _complete.parseText)(input.value);
        complete.setText({
          text: p.parsedText,
          values: _objectSpread({}, p.values)
        });
        quest.text = p.parsedText;
        quest.answers = _objectSpread({}, p.values);
    ...
    match: function match() {
      ...
      var match = new _match.Match($placeholder, {
        left: quest.left,
        right: quest.right,
        connections: quest.answers.map(function (_ref2) {
          var _ref3 = _slicedToArray(_ref2, 2),
              l = _ref3[0],
              r = _ref3[1];
      ...
      var $addLeft = (0, _utils.createElementFrom)("<button type=\"button\" class=\"filled-button small secondary\">add left</button>");
      var $addRight = (0, _utils.createElementFrom)("<button type=\"button\" class=\"filled-button small secondary\">add right</button>");
      $btnWrap.append($addLeft, (0, _utils.createElementFrom)("<span class=\"spacex-1\"></span>"), $addRight);

      _this.$content.append((0, _utils.createElementFrom)("<div class=\"spacey-1\"></div>"), $btnWrap);
...
exports.EditableQuizSection = EditableQuizSection;
},{"./check-list":"components/check-list.js","./complete":"components/complete.js","./match":"components/match.js","./text-field":"components/text-field.js","./utils":"components/utils.js"}],"components/select.js":[function(require,module,exports) {
"use strict";
...
var Select = /*#__PURE__*/function () {
  ...
  _createClass(Select, [{
    key: "addOption",
    value: function addOption(o) {
      var _this2 = this;

      var $option = (0, _utils.createElementFrom)("\n      <div class=\"select__option\">".concat(o.value, "</div>\n    "));
      $option.addEventListener("click", function () {
        _this2.$input.value = o.value;

        if (o.value) {
          _this2.$element.classList.add("has-text");
        }
...
},{"./utils":"components/utils.js"}],"components/modal.js":[function(require,module,exports) {
"use strict";
 ...
 * @returns
 */
function promptModal(what, _ref) {
  var _ref$multiline = _ref.multiline,
      ...
      _ref$required = _ref.required,
      required = _ref$required === void 0 ? false : _ref$required;
  var $modal = createModal(what);
  var input = new _textField.ULTextField($modal.querySelector("#content"), {
    multiline: multiline,
    placeholder: placeholder,
    value: value,
    required: required
  });
  return runModal($modal).then(function () {
    return input.value;
  });
}
/**
...
function selectModal(what, _ref2) {
  ...
  var $modal = createModal(what);
  var select = new _select.Select($modal.querySelector("#content"), {
    label: label,
    required: required,
    options: options
  });
...
function runModal($modal) {
  ...
  return new Promise(function (resolve, reject) {
    ...
    $modal.querySelector(".modal__cancel").addEventListener("click", function () {
      close(reject);
    });
  });
}
},{"./select":"components/select.js","./text-field":"components/text-field.js","./utils":"components/utils.js"}],"create-quiz.js":[function(require,module,exports) {
"use strict";

var _editableQuizSection = require("./components/editable-quiz-section");
...
function Init(quiz) {
  ...
  $quiz.innerHTML = "";
  var $quizName = (0, _utils.createElementFrom)("\n    <div class=\"paper-6\">\n      <div class=\"title accent big\">\n        <div id=\"quiz-name\"></div>\n      </div>\n    </div>\n  ");
  var $questsContainer = document.createElement("div");
  var $btnWrap = (0, _utils.createElementFrom)("\n    <div class=\"flex-end\">\n      <button class=\"filled-button primary quiz__add\">Add quest</button>\n      <div class=\"spacex-1\"></div>\n      <button class=\"filled-button success quiz__submit\">submit</button>\n    </div>\n  ");
  var $addQuestBtn = $btnWrap.querySelector(".quiz__add");
  var $submitBtn = $btnWrap.querySelector(".quiz__submit");
  $quiz.append((0, _utils.createElementFrom)("<div class=\"spacey-2\"></div>"), $quizName, (0, _utils.createElementFrom)("<div class=\"spacey-2\"></div>"), $questsContainer, (0, _utils.createElementFrom)("<span class=\"spacex-3\"></span>"), $btnWrap, (0, _utils.createElementFrom)("<div class=\"spacey-4\"></div>"));
  var quizNameInput = new _textField.ULTextField($quizName.querySelector("#quiz-name"), {
    value: quiz.name,
  ...
  quizNameInput.onInput = function () {
  ...
  $addQuestBtn.addEventListener("click", function () {
    (0, _modal.selectModal)("Choose the type of the quest", {
      label: "Type",
      required: true,
      options: [["question", "Question"], ["choose one", "Choose one"], ["choose multiple", "Choose multiple"], ["complete", "Complete text"], ["match", "Match sides"]].map(function (o) {
        return {
          key: o[0],
          value: o[1]
        };
      ...
      var eqs = new _editableQuizSection.EditableQuizSection($placeholder, {
        quest: newQuest
      });
      quizSections.push(eqs);

      eqs.onRemove = function () {
        quiz.quests = quiz.quests.filter(function (q) {
          return q != newQuest;
        });
        quizSections = quizSections.filter(function (qs) {
          return qs != eqs;
        });
      };
    }, function () {});
  ...
  $submitBtn.addEventListener("click", function () {
    var valid = quizNameInput.reportValidity();
    if (valid) valid && (valid = quizSections.every(function (qs) {
      return qs.reportValidity();
    }));
...
Init(quiz);
window["Init"] = Init; // ?_id=skdfjas-asdfkljasdfp-asdfaslkdfj-asdfklj
},{"./components/editable-quiz-section":"components/editable-quiz-section.js","./components/modal":"components/modal.js","./components/text-field":"components/text-field.js","./components/utils":"components/utils.js"}],"C:/Users/nordd/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["C:/Users/nordd/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","create-quiz.js"], null)
//# sourceMappingURL=/create-quiz.3b6382b2.js.map